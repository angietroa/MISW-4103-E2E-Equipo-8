...
describe("E006 - Funcionalidad de creación de un post con markdown aleatorio", () => {
  ...
  it("Debe iniciar sesión y crear un post con markdown", async () => {
    ...
    postPage.addMarkdown(dataAPriori[5].paragraph);
    ...
    postPage.verifyContent("p", dataAPriori[5].paragraph);
  });
});
