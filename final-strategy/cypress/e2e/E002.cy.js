...
describe("E002 - Funcionalidad de creación de un post con un único carácter invisible en pantalla en titulo y contenido", () => {
  ...
  it("Funcionalidad de creación de un post con un único carácter invisible en pantalla en titulo y contenido", async () => {
    ...
    const postTitle = dataAPriori[1].emptyField;
