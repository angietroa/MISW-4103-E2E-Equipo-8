...
describe("E077 - Crear un tag con descripcion de 501 caracteres (pseudo-aleatorio)", () => {
  ...
  it("Crear un tag con descripcion de 501 caracteres (pseudo-aleatorio)", async () => {
    ...
    cy.get('@tagData').then(res => {
      ...
      tagPage.setTagDescription(res.body.description_long);
