...
describe("E013 -Funcionalidad de creación de un post con Vimeo embebido", () => {
  ...
  it("Debe iniciar sesión y crear un post con Vimeo embebido", async () => {
    ...
    const postTitle = postPage.generateTitlePost(
      `${dataAPriori[12].postTitle} con Vimeo`
    );
    postPage.createTitlePost(postTitle);

    postPage.embedContent('button:contains("Vimeo")', dataAPriori[12].vimeoUrl);
    cy.wait(1000);
