...
describe('Crear tag', () => {
    ...
    it('E014 - Crear tag con "X card"', () => {
        ...
        cy.log({ displayName: 'When', message: 'I enter x card values with an image, a title and a description' });
        tagPage.setXCardValues('rocket-icon.png', faker.lorem.word(), faker.lorem.sentence());
