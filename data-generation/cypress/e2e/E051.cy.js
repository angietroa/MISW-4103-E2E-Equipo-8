...
describe("E048 - Crear página embebiendo link de Soundcloud con link invalido pseudo-aleatorio", () => {
  beforeEach(() => {
    cy.request(PAGE_DATA_POOL_PSEUDO_RANDOM_ENDPOINT).as("page_data");
  });

  it("E048 - Crear página embebiendo link de Soundcloud con link invalido pseudo-aleatorio", () => {
