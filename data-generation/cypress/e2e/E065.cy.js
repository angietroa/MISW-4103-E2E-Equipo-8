...
describe("E064 - Crear un tag con nombre con solo caracteres especiales (pseudo-aleatorio)", () => {
  ...
  it("Crear un tag con nombre con solo caracteres especiales (pseudo-aleatorio)", async () => {
    ...
    cy.get('@tagData').then(res => {
      ...
      tagPage.setTagName(res.body.name_special_char);
      ...
      tagPage.findTagNameCreated(res.body.name_special_char);
    });
  });
});
