...
describe("E079 - Crear un tag con titulo de metadata con 70 caracteres (a priori)", () => {
  const loginPage = new LoginPage(cy);
  const tagPage = new TagPage(cy);

  it("Crear un tag con titulo de metadata con 70 caracteres (a priori)", async () => {
    ...
    const data = TAG_DATA_POOL_A_PRIORI[8];
