...
describe('Crear tag', () => {
    ...
    it('E015 - Crear tag con "Facebook card"', () => {
        ...
        cy.log({ displayName: 'When', message: 'I enter facebook card values with an image, a title and a description' });
        tagPage.setFacebookCardValues('rocket-icon.png', faker.lorem.word(), faker.lorem.sentence());
