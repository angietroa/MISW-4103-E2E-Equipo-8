...
describe("E019 - Funcionalidad de creación de un post con botón con un único carácter invisible en pantalla", () => {
  ...
  it("Debe crear un post con un botón con un único carácter invisible en pantalla y validarlo", async () => {
    ...
    const postTitle = postPage.generateTitlePost(
      `${dataAPriori[18].postTitle} con botón`
    );
    postPage.createTitlePost(postTitle);

    postPage.addButton(dataAPriori[18].emptyField);
